    ...
    container.innerHTML = `
      <div class="flex-1 w-full max-w-7xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6" style="margin-left: 48px;">
            ...
            <div class="flex flex-col gap-6">
                <div class="p-5" style="background: var(--card); border: 1px solid var(--border); border-radius: var(--card-radius);">
                    <h3 class="font-bold text-main mb-4" style="font-size: 1rem;"><i class="fas fa-font mr-2"></i>Typography</h3>
                    ...
                    <div class="flex justify-between items-center py-2 border-b border-[color:var(--border)]"><span class="font-bold text-main" style="font-size: 0.85rem;">Text Color</span> <input type="color" class="w-10 h-8 rounded cursor-pointer border-0 bg-transparent color-picker" data-var="--text" value="${getVal('--text')}"></div>
                ...
                <div class="p-5" style="background: var(--card); border: 1px solid var(--border); border-radius: var(--card-radius);">
                    ...
                    <div class="flex justify-between items-center py-2 border-b border-[color:var(--border)]"><span class="font-bold text-main" style="font-size: 0.85rem;">Padding</span> <input type="text" class="w-16 p-1 border rounded size-input font-mono text-xs" style="background:var(--bg); color:var(--text); border-color:var(--border);" data-var="--main-padding" value="${getVal('--main-padding')}"></div>
